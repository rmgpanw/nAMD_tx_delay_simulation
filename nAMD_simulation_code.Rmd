...
simulations_summary_final <- simulations_summary %>% 
  mutate(
    ...
    CI_lower_mean_one_year_va = map_dbl(data, ~ mean(.x$mean_one_year_va) - 2*sd(.x$mean_one_year_va)),
    CI_upper_mean_one_year_va = map_dbl(data, ~ mean(.x$mean_one_year_va) + 2*sd(.x$mean_one_year_va)),
    
    mean_baseline_va = map_dbl(data, ~ mean(.x$mean_baseline_va)),
    sd_baseline_va = map_dbl(data, ~sd(.x$mean_baseline_va)),
    CI_lower_mean_baseline_va = map_dbl(data, ~ mean(.x$mean_baseline_va) - 2*sd(.x$mean_baseline_va)),
    CI_upper_mean_baseline_va = map_dbl(data, ~ mean(.x$mean_baseline_va) + 2*sd(.x$mean_baseline_va)),
    
    pct_va_worse_6_60 = map_dbl(data, ~ mean(.x$pct_va_worse_6_60)),
    sd_pct_va_worse_6_60 = map_dbl(data, ~ sd(.x$pct_va_worse_6_60)),
    CI_lower_pct_va_worse_6_60 = map_dbl(data, ~ mean(.x$pct_va_worse_6_60) - 2*sd(.x$pct_va_worse_6_60)),
    CI_upper_pct_va_worse_6_60 = map_dbl(data, ~ mean(.x$pct_va_worse_6_60) + 2*sd(.x$pct_va_worse_6_60)),
    
    pct_va_worse_6_24 = map_dbl(data, ~ mean(.x$pct_va_worse_6_24)),
    sd_pct_va_worse_6_24 = map_dbl(data, ~ sd(.x$pct_va_worse_6_24)),
    CI_lower_pct_va_worse_6_24 = map_dbl(data, ~ mean(.x$pct_va_worse_6_24) - 2*sd(.x$pct_va_worse_6_24)),
    CI_upper_pct_va_worse_6_24 = map_dbl(data, ~ mean(.x$pct_va_worse_6_24) + 2*sd(.x$pct_va_worse_6_24)),
    
    pct_va_better_6_12 = map_dbl(data, ~ mean(.x$pct_va_better_6_12)),
    sd_pct_va_better_6_12 = map_dbl(data, ~ sd(.x$pct_va_better_6_12)),
    CI_lower_va_better_6_12 = map_dbl(data, ~ mean(.x$pct_va_better_6_12) - 2*sd(.x$pct_va_better_6_12)),
    CI_upper_va_better_6_12 = map_dbl(data, ~ mean(.x$pct_va_better_6_12) + 2*sd(.x$pct_va_better_6_12)),
